	...
	<el-container>
				...
				<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
					<el-form :inline="true" :model="filters" label-width="100px" size="small">
						<el-col :span="24">
							...
							<el-col :span="6">
								<el-form-item label="加盟机构级别" prop="jibie">
									<el-select v-model="ruleForm.jibie" placeholder="请选择">
							...
							<el-col :span="6">
								<el-form-item label="加盟机构名称" prop="region">
      ...
      start-placeholder="开始日期"
				...
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					...
					<el-table-column prop="birth" label="业务类型">
					</el-table-column>
					<el-table-column prop="birth" label="人次">
					</el-table-column>
					<el-table-column prop="addr" label="业务总额">
					</el-table-column>
					<el-table-column prop="name" label="现金收款">
					</el-table-column>
					<el-table-column prop="birth" label="刷卡收款">
					</el-table-column>
					<el-table-column prop="birth" label="券额">
					</el-table-column>
					<el-table-column prop="addr" label="小程序支付">
					</el-table-column>
					<el-table-column prop="name" label="微信/支付宝">
					</el-table-column>
					<el-table-column prop="birth" label="其他支付">
					</el-table-column>
					<el-table-column prop="birth" label="退款总额">
					</el-table-column>
					<el-table-column label="操作" width="200">
						<template slot-scope="scope">
							<el-button type="text" size="small" @click="handleEdit(scope.$index, scope.row)">营收明细</el-button>
						</template>
					</el-table-column>
