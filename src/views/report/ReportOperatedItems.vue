			...
			<section>
				...
				<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
					<el-form :inline="true" :model="filters" label-width="100px" size="small">
						<el-col :span="24">
							<el-col :span="6">
								<el-form-item label="显示结果" prop="jieguo">
									<el-select v-model="ruleForm.jieguo" placeholder="请选择">
										<el-option label="结果一" value="shanghai"></el-option>
										<el-option label="结果二" value="beijing"></el-option>
									</el-select>
								</el-form-item>
							</el-col>
							<el-col :span="6">
