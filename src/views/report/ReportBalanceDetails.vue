		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				...
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					...
					<el-table-column prop="addr" label="私密管家">
					</el-table-column>
					<el-table-column prop="name" label="客服人员">
					</el-table-column>
					<el-table-column prop="birth" label="充值类型">
					</el-table-column>
					<el-table-column prop="birth" label="余额">
					</el-table-column>
					<el-table-column prop="addr" label="赠送券额">
					</el-table-column>
					<el-table-column prop="name" label="充值开发人">
					</el-table-column>
					<el-table-column prop="birth" label="结算状态">
					</el-table-column>
