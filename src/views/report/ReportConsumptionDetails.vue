		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				...
				<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
					<el-form :inline="true" :model="filters" label-width="100px" size="small">
						<el-col :span="24">
							...
							<el-col :span="6">
								<el-form-item label="商品子类" prop="zilei">
									<el-select v-model="ruleForm.zilei" placeholder="请选择">
										<el-option label="子类一" value="shanghai"></el-option>
										<el-option label="子类二" value="beijing"></el-option>
									</el-select>
								</el-form-item>
							</el-col>
						...
						<el-col :span="24">
							...
							<el-col :span="6">
								<el-form-item label="分诊方式" prop="fangshi">
									<el-select v-model="ruleForm.fangshi" placeholder="请选择">
				...
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					...
					<el-table-column  fixed prop="name" label="消费日期" width="120">
					</el-table-column>
					<el-table-column prop="name" label="会员号" width="120">
					</el-table-column>
					<el-table-column prop="name" label="顾客姓名" width="120">
					</el-table-column>
					<el-table-column prop="name" label="年龄" width="120">
					</el-table-column>
					...
					<el-table-column prop="name" label="应付金额" width="120">
					</el-table-column>
					<el-table-column prop="name" label="已付金额" width="120">
					</el-table-column>
					<el-table-column prop="name" label="本次用额" width="120">
					</el-table-column>
					<el-table-column prop="name" label="项目余额" width="120">
					</el-table-column>
					<el-table-column prop="name" label="使用次数" width="120">
					</el-table-column>
					<el-table-column prop="name" label="收款金额" width="120">
					</el-table-column>
					<el-table-column  prop="name" label="现金支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="小程序支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="支付宝支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="微信支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="银联支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="信用卡支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="电子券支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="赠送免单" width="120">
					</el-table-column>
					<el-table-column prop="name" label="存款支付" width="120">
					</el-table-column>
					<el-table-column prop="name" label="医生" width="120">
					</el-table-column>
					<el-table-column prop="name" label="咨询人员" width="120">
					</el-table-column>
					<el-table-column prop="name" label="客服人员" width="120">
					</el-table-column>
					<el-table-column prop="name" label="出诊日期" width="120">
					</el-table-column>
					<el-table-column prop="name" label="治疗师" width="120">
					</el-table-column>
					<el-table-column prop="name" label="分诊方式" width="120">
					</el-table-column>
