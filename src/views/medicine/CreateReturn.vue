		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				<el-form :model="proTypeForm"  label-width="90px"  ref="proTypeForm" size="mini">
					<el-form-item label="采购订单：" style="width:50%;">
						{{proTypeForm.type}}/{{proTypeForm.orderid}}
					</el-form-item>

					<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 80%;">
						<el-table-column prop="name" label="商品名称" width="120">
						</el-table-column>
						<el-table-column prop="birth" label="商品条码" min-width="120">
						</el-table-column>
						<el-table-column prop="birth" label="单位" width="120">
						</el-table-column>
						<el-table-column prop="addr" label="规格" min-width="120">
						</el-table-column>
						<el-table-column prop="addr" label="可用库存" min-width="120">
						</el-table-column>
						<el-table-column prop="birth" label="采购数量" width="120">
						</el-table-column>

					</el-table>
					<el-form-item label="退货原因：" style="width:50%;margin-top:20px;">
