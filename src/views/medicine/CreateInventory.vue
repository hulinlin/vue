		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				<el-form :model="proTypeForm"  label-width="90px"  ref="proTypeForm" size="mini">
					...
					<el-form-item label="商品条码：" style="width:50%;">
					...
					<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 80%;">
						...
						<el-table-column prop="addr" label="实际数量" min-width="120">
						</el-table-column>
						<el-table-column prop="birth" label="盘入数量" width="120">
						</el-table-column>
						<el-table-column prop="birth" label="差异数量" width="120">
						</el-table-column>
						...
						<el-form-item>
							<el-button type="primary" size="small" v-on:click="getUsers">完成盘点</el-button>
