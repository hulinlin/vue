		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				...
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					<el-table-column prop="name" label="采购出库单编码" width="150">
					</el-table-column>
					<el-table-column prop="birth" label="来源采购退货单" width="150">
					</el-table-column>
	...
	export default {
		...
		methods: {
			...
			proTypeSubmit: function (){
				this.$router.push({name:'新建采购出库申请',params:{type:this.proTypeForm.type,orderid:this.proTypeForm.orderid}});
			},
			//显示编辑界面
