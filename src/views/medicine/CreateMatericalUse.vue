<template>
    ...
    <el-option>
					...
					<el-form-item label="顾客姓名：">
						<el-input v-model="proTypeForm.num" size="small" auto-complete="off"></el-input>
					</el-form-item>
						</el-col>
						<el-col :span="4">
					...
					<el-form-item label="是否归还：">
						<el-select v-model="proTypeForm.num" placeholder="请选择" size="small">
					...
					<el-form-item>
						<el-button type="primary" size="small" v-on:click="getUsers">确定领用</el-button>
