			...
			<section>
				<el-form :model="proTypeForm"  label-width="90px"  ref="proTypeForm" size="mini">
					...
					<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 80%;">
						...
						<el-table-column prop="birth" label="材料/药品条码" min-width="150">
						</el-table-column>
						<el-table-column prop="birth" label="是否归还" width="120">
						</el-table-column>
						<el-table-column prop="addr" label="顾客姓名" min-width="120">
						</el-table-column>
						<el-table-column prop="birth" label="领用数量" width="120">
						</el-table-column>
						<el-table-column prop="birth" label="已归还数量" width="120">
						</el-table-column>
						<el-table-column prop="birth" label="待归还数量" width="120">
						</el-table-column>
					</el-table>
					<el-form-item label="备注：" style="width:50%;margin-top:20px;">
						...
						<el-form-item>
							<el-button type="primary" size="small" v-on:click="getUsers">确定归还</el-button>
							<el-button  size="small" v-on:click="getUsers">取消</el-button>
						</el-form-item>
