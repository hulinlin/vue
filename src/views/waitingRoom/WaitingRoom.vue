		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				...
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					<el-table-column prop="name" label="就诊号" width="120">
					</el-table-column>
					<el-table-column prop="name" label="VIP" width="">
					</el-table-column>
					<el-table-column prop="birth" label="分诊日期" width="120">
					</el-table-column>
					<el-table-column prop="addr" label="姓名" min-width="120">
					</el-table-column>
					<el-table-column prop="name" label="年龄" width="120">
					</el-table-column>
					<el-table-column prop="birth" label="地区" width="">
					</el-table-column>
					<el-table-column prop="birth" label="联系电话" width="120">
					</el-table-column>
					<el-table-column prop="addr" label="顾客需求" min-width="120">
					</el-table-column>
					<el-table-column prop="name" label="分诊管家" width="120">
					</el-table-column>
					<el-table-column prop="name" label="就诊状态" width="120">
					</el-table-column>
