			...
			<section>
				...
				<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
					<el-form :inline="true" :model="filters" size="small">
						...
						<el-form-item label="来院日期" prop="region">
							<el-col :span="11">
				...
				<el-col :span="24" class="toolbar" style="padding: 0px;">
					<el-form :inline="true" :model="filters" label-width="100px">
						...
						<el-form-item>
							<el-button type="primary" size="small" v-on:click="getUsers">今天</el-button>
						</el-form-item>
					</el-form>
				</el-col>
				<!--列表-->
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					...
					<el-table-column prop="name" label="新顾客">
						<el-table-column prop="name" label="分诊">
						</el-table-column>
						<el-table-column prop="name" label="接诊">
						</el-table-column>
						<el-table-column prop="name" label="成交">
						</el-table-column>
						<el-table-column prop="name" label="成交率">
						</el-table-column>
					</el-table-column>
					<el-table-column prop="name" label="老顾客">
						<el-table-column prop="name" label="分诊">
						</el-table-column>
						<el-table-column prop="name" label="接诊">
						</el-table-column>
					...
					<el-table-column prop="birth" label="当前接诊">
					</el-table-column>
					<el-table-column prop="birth" label="来院日期">
					</el-table-column>
				</el-table>
