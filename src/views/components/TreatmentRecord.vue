<template>
    <div>
        ...
        <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="name" label="开发日期">
            </el-table-column>
            <el-table-column prop="name" label="已使用/总次数" width="150">
            </el-table-column>
            <el-table-column prop="name" label="单价/折扣" >
            </el-table-column>
            <el-table-column prop="name" label="成交价">
            </el-table-column>
            <el-table-column prop="name" label="已付金额">
            </el-table-column>
            <el-table-column prop="name" label="状态" >
            </el-table-column>
            <el-table-column prop="name" label="操作" width="200">
                <template slot-scope="scope">
                    <el-button type="text"  size="small" @click="ordered(scope.$index, scope.row)">退款</el-button>
                    <el-button type="text"  size="small" @click="ordered(scope.$index, scope.row)">治疗日志</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-dialog title="治疗记录" v-model="orderedFormVisible" :close-on-click-modal="false" class="middleDialog">
            <el-table  highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
                ...
                <el-table-column prop="name" label="治疗时间">
                </el-table-column>
                <el-table-column prop="name" label="次数" >
                </el-table-column>
                <el-table-column prop="name" label="治疗医师">
                </el-table-column>
            </el-table>
