		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				...
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					<el-table-column prop="name" label="预约回访时间" width="120">
					</el-table-column>
					<el-table-column prop="birth" label="顾客姓名" width="">
					</el-table-column>
					<el-table-column prop="birth" label="联系方式" width="120">
					</el-table-column>
					<el-table-column prop="addr" label="回访类型" min-width="120">
					</el-table-column>
					<el-table-column prop="name" label="回访人" width="120">
					</el-table-column>
					<el-table-column prop="birth" label="累计回访次数" width="">
					</el-table-column>
					<el-table-column prop="birth" label="回访内容" width="120">
					</el-table-column>
					<el-table-column prop="addr" label="回访状态" min-width="120">
					</el-table-column>
