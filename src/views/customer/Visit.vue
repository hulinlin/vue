                ...
                <section>
                    ...
                    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                        <el-form :inline="true" :model="filters" size="small">
                            ...
                            <el-form-item>
                                <el-button type="primary" size="small" v-on:click="record">添加回访记录</el-button>
                            </el-form-item>
                            <el-form-item>
                                <el-button type="primary" size="small" v-on:click="ordered">预约来院</el-button>
                            </el-form-item>
                        </el-form>
                    </el-col>
                    ...
                    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
                        <el-table-column prop="name" label="咨询人">
                        </el-table-column>
                        <el-table-column prop="birth" label="联系方式" >
                        </el-table-column>
                        <el-table-column prop="birth" label="回访时间">
                        </el-table-column>
                        <el-table-column prop="addr" label="回访内容">
                        </el-table-column>
            ...
            <el-form :model="orderedForm" label-width="80px" :rules="editFormRules" ref="orderedForm" size="small">
                <el-form-item label="联系方式" prop="region">
                    <el-select v-model="ruleForm.region" placeholder="请选择">
                        ...
                        <el-option label="QQ" value="beijing"></el-option>
                        <el-option label="手机" value="shanghai"></el-option>
                    </el-select>
                </el-form-item>
            <el-form-item label="回访内容" prop="region">
                <el-input type="textarea" v-model="orderedForm.desc"></el-input>
            </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
