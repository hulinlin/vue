            ...
            <el-row>
                <section>
                    ...
                    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
                        ...
                        <el-table-column prop="birth" label="项目名称" width="120">
                        </el-table-column>
                        <el-table-column prop="birth" label="开发人" width="80">
                        </el-table-column>
                        <el-table-column prop="addr" label="开发日期" min-width="120">
                        </el-table-column>
                        <el-table-column prop="name" label="已使用/总数" width="120">
                        </el-table-column>
                        <el-table-column prop="birth" label="单价/折扣" width="120">
                        </el-table-column>
                        <el-table-column prop="birth" label="成交价" width="100">
                        </el-table-column>
                        <el-table-column prop="addr" label="已付金额" width="120">
                        </el-table-column>
                        <el-table-column prop="name" label="沟通记录" width="120">
