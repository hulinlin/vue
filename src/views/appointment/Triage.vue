		...
		<el-col :span="24" style="padding:0 20px;">
			<section>
				...
				<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
					...
					<el-table-column prop="birth" label="年龄" width="120">
					</el-table-column>
					<el-table-column prop="addr" label="地区" min-width="120">
					</el-table-column>
					<el-table-column prop="name" label="渠道来源" width="120">
					</el-table-column>
					<el-table-column prop="birth" label="联系电话" width="">
					</el-table-column>
					<el-table-column prop="birth" label="微信" width="120">
					</el-table-column>
